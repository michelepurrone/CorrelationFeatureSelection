...
ciclo:
        ...
        mov eax, [nx]
        mov ebx, [ebp+r] 		;ebx=indiceRiga
        cdq
        div ebx   			    ;n/indiceRiga
        mov [i], eax 			;i=n/indiceRiga
        mov [j], edx 			;j=n%indiceRiga

        ;-----kt[n]=k[indiceCol*j+i]
